...
class GasolineTest {
    ...
    public void setup1() {
        ...
        gasoline = new Gasoline(0, 57849439, "BMW", 2020, 65329, 9868, 'U', "345-4533", "", documents, 'S', 4, true, 32, 'O', 0);
    }
    ...
    public void setup2() {
        ...
        gasoline = new Gasoline(0, 57849439, "BMW", 2020, 65329, 9868, 'U', "9887-54", "", documents, 'S', 4, true, 32, 'O', 0);
    }
    ...
    public void setup3() {
        ...
        gasoline = new Gasoline(0, 57849439, "BMW", 2020, 65329, 9868, 'U', "2132-546", "", documents, 'S', 4, true, 32, 'O', 0);
    }
    ...
    public void setup4() {
        ...
        documents.setFirst(new Soat(121236, 2020, "47983432", 905680));
        documents.getFirst().setNext(new Review(544556, 2020, "76542235", 98989));
        gasoline = new Gasoline(0, 57849439, "BMW", 2020, 65329, 9868, 'U', "765-1221", "", documents, 'S', 4, true, 32, 'O', 0);
    }
    ...
    public void setup5() {
        ...
        gasoline = new Gasoline(0, 57849439, "BMW", 2020, 65329, 0, 'N', "", "", documents, 'S', 4, true, 32, 'O', 0);
    }
    ...
    public void setup6() {
        ...
        documents.setFirst(new Soat(121236, 0, "", 905680));
        documents.getFirst().setNext(new Review(544556, 0, "", 0));
        gasoline = new Gasoline(0, 57849439, "BMW", 2020, 4736, 0, 'N', "", "", documents, 'S', 4, true, 34682, 'O', 0);
    }
