...
public class BSTClientsInCharge implements Serializable {
    ...
    /**
     * Name: getSize Method used to get the size of the binary search tree that
     * stores clients attended by an employee. <br>
     * 
     * @return An int representing the size of the binary search tree that stores
     *         clients attended by an employee.
     */
    public int getSize() {
        return size;
    }
    ...
    /**
     * Name: setSize Method used to update the size of the binary search tree that
     * stores clients attended by an employee. <br>
     * 
    ...
    /**
     * Name: getRoot Method used to get the root of the binary search tree that
     * stores clients attended by an employee. <br>
     * 
     * @return A Client object representing the root of the binary search tree that
     *         stores clients attended by an employee.
     */
    ...
    /**
     * Name: setRoot Method used to update the root of the binary search tree that
     * stores clients attended by an employee. <br>
     * 
    ...
    /**
     * Name: addAssignedClient Method used to add a Client node in the binary search
     * tree. <br>
     * <b>pre: </b> Binary search tree of clients attended by an employee already
     * initialized. <br>
     * <b>post: </b> Adding process of a client in the binary search tree
     * determined. <br>
     * 
     * @param assigned - Client that an employee will have in his/her charge.
     * @return A boolean with true if the client was added successfully to the BST,
     *         or with false if not.
     */
    ...
    /**
     * Name: addAssignedClient Recursive method used to add a Client node in the
     * binary search tree, when the root is different from null. <br>
     * <b>pre: </b> Binary search tree of clients attended by an employee already
     * initialized. <br>
     * <b>post: </b> Adding process of a client in the binary search tree
     * determined. <br>
     * 
     * @param current   - Current Client in the BST traversal - current = Client
     *                  object, current != null
     * @param newClient - Client in question to be added to the BST - newClient =
     *                  Client object, newClient != null
     */
    ...
    /**
     * Name: searchClientInCharge Method used to search a Client node in the binary
     * search tree. <br>
     * <b>pre: </b> Binary search tree of clients attended by an employee already
     * initialized. <br>
     * <b>post: </b> Searching process of a client in the binary search tree
     * determined. <br>
     * 
     * @param phone - Client's phone - phone = String, phone != null, phone != "".
     * @return A Client object different from null if the client in question was
     *         found in the BST, or equal to null if not.
     */
    ...
    /**
     * Name: searchClientInCharge Recursive method used to search a Client node in
     * the binary search tree, when the root is different from null. <br>
     * <b>pre: </b> Binary search tree of clients attended by an employee already
     * initialized. <br>
     * <b>post: </b> Searching process of a client in the binary search tree
     * determined. <br>
    ...
    /**
     * Name: removeClientsInCharge Method used to remove a Client node from the
     * binary search tree. <br>
     * <b>pre: </b> Binary search tree of clients attended by an employee already
     * initialized. <br>
     * <b>post: </b> Removing process of a client from the binary search tree
     * determined. <br>
     * 
     * @param phone - Client's phone - phone = String, phone != null, phone != "".
     */
    ...
    /**
     * Name: removeClientsInCharge Recursive method used to remove a Client node in
     * the binary search tree, when this client exists. <br>
     * <b>pre: </b> Binary search tree of clients attended by an employee already
     * initialized. <br>
     * <b>post: </b> Removing process of a Client from the binary search tree
     * determined. <br>
     * 
     * @param nodeToErase - Client node in question to be removed from the BST -
     *                    nodeToErase = Client object, nodeToErase != null
     */
    ...
    /**
     * Name: goToLeft Recursive method used to get the Client node located further
     * to the left of the BST. <br>
     * <b>pre: </b> Binary search tree of clients attended by an employee already
     * initialized. <br>
     * <b>post: </b> Arrival at the leftmost Client node of the BST. <br>
     *
     * @param node - current client where the traversal to the leftmost Client node
     *             will begin - node = Client object, node != null
     */
    ...
    /**
     * Name: printClientsInCharge Method used to print the clients data present in
     * the BST, after an inorder traversal through it. <br>
     * <b>pre: </b> Binary search tree of clients attended by an employee already
     * initialized. <br>
     * <b>post: </b> An enumerated vertical list of the clients data present in the
     * BST has been printed. <br>
     * 
     * @param client - Current client in the BST inorder traversal - client = Client
     *               object
     * @return A String with the clients data present in the BST, or an empty String
     *         if the root was null.
     */
